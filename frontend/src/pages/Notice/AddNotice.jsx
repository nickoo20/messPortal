...
const NoticeForm = () => {
  ...
  return (
    <div className="mt-10 min-h-screen">
      ...
      <div className="max-w-md mx-auto bg-white p-5 rounded shadow-sm border-green-500 border-r-4">
        <h2 className="text-2xl font-bold font-jakarta text-green-700 mb-6 text-center">Add a new Notice</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <button
              type="submit"
              className="bg-green-700 hover:opacity-85 hover:bg-green-800 text-white rounded-2xl
